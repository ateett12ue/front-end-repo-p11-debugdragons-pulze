  ...
  return (
    <Dialog open={openModal} onOpenChange={setOpenModal}>
      ...
      <DialogContent className="sm:max-w-[800px] h-full flex flex-col justify-between items-start border border-slate-500">
        <DialogHeader>
          <DialogTitle className="flex  font-semibold justify-start text-lg"></DialogTitle>
        ...
        <div className="flex flex-col gap-14">
          <div className="flex flex-col gap-2">
            ...
            <Input
              className="flex grow text-sm font-normal  border-2 w-[600px] border-2"
              placeholder="Name"
              type="text"
              value={userName}
        ...
        <DialogFooter className="flex flex-col gap-8 justify-center items-center mb-44">
          <Button
            type="submit"
            className="bg-[#8645FF] hover:bg-[#8645FF] w-26 h-18 rounded-r-md  font-semibold text-lg"
